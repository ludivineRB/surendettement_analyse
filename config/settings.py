...
SURENDETTEMENT_API_URL = os.getenv(
    ...
    f"{SURENDETTEMENT_API_BASE_URL}/api/data/streamlit?limit=50000",
)
INCLUSION_FINANCIERE_API_URL = os.getenv(
    "INCLUSION_FINANCIERE_API_URL",
    f"{SURENDETTEMENT_API_BASE_URL}/api/data/inclusion-financiere?limit=100000",
)
REGIONAL_MACRO_API_URL = os.getenv(
    "REGIONAL_MACRO_API_URL",
    f"{SURENDETTEMENT_API_BASE_URL}/api/data/macro-economic-regions?limit=5000",
)
