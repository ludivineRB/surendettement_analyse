...
Résultat métier correct : **5/8** (ordre exact : 5/8).
...
|---|---:|---:|---:|---:|
| DataFusion | non | 0/0 | — | — |
| SQLFluff | oui | 11/12 | 28.4122 ms | 105.1512 ms |
| SQLGlot | oui | 11/12 | 0.7547 ms | 2.0176 ms |
| polyglot-sql | oui | 11/12 | 0.0753 ms | 0.1395 ms |
| sqloxide | oui | 11/12 | 0.1591 ms | 0.3238 ms |
| sqlparse | oui | 12/12 | 1.5989 ms | 4.7061 ms |
